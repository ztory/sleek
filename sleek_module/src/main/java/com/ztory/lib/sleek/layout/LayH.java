 ...
 */
public class LayH extends LayBounds {
...
//            POS_PARENT_PERCENT = SlkLay.POS_PARENT_PERCENT;
    ...
    LayH(IComputeInt theComputeInt) {
    ...
    LayH(int theMode, int theMargin, Sleek theParent) {
        mode = theMode;
        margin = theMargin;
        parent = theParent;
    }

    LayH(int theMode, int theMargin, Sleek theParent, float thePercent) {
        mode = theMode;
        margin = theMargin;
        parent = theParent;
        percent = thePercent;
